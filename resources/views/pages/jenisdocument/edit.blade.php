...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-5 align-self-center">
            <h4 class="page-title">Menu Pembuatan Data Jenis Docoument Hukum Baru</h4>
        </div>
...
<div class="row">
    <div class="col-sm-12 col-lg-12">
        <div class="card">
            <form method="POST" action="{{ route('dashboard.jenisdocument.update', $jenisdocuments->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <label for="nama" class="control-label col-form-label">Nama Jenis Dokumen Hukum</label>
                            <div class="input-group">
                                ...
                                <input type="text" id="nama" name="nama" class="form-control"
                                    value="{{$jenisdocuments->nama}}" placeholder="Nama Jenis Hukum Hukum" required>
                            </div>
                        </div>
