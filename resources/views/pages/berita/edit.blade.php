                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea name="isi" id="isi" class="form-control"
                            style="height: 300px !important;">{{ old('isi', $beritum->isi) }}</textarea>
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        @if ($beritum->gambar)
                        <div class="mt-2">
                            <img src="{{ asset('uploads/berita/' . $beritum->gambar) }}" width="150" alt="Gambar Berita">
                            <p class="text-muted mt-1 mb-0"><small>Gambar saat ini</small></p>
                        </div>
                        @endif
                    </div>
