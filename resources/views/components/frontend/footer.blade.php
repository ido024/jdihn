        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="about">
                    ...
                    <p>If you consider that <a rel="nofollow" href="https://templatemo.com/tm-564-plot-listing"
                            ...
                            rel="nofollow" href="https://www.paypal.me/templatemo" target="_blank">support
                            us</a> a little via PayPal.</p>
                </div>
            </div>
            <div class="col-lg-4">
            ...
            <div class="col-lg-4">
                <div class="contact-us">
                    <h4>Contact Us</h4>
                    <p>Bagian Hukum Sekeretariat Daerah
                        Jl. A.Yani No.01</p>
                    <div class="row">
                        <div class="col-lg-6">
            ...
            <div class="col-lg-12">
                <div class="sub-footer">
                    <p>Copyright © 2021 Biro Hukum Setda Provinsi Jambi. All Rights Reserved.
                        <br>
